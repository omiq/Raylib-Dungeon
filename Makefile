...
RaylibGame: raylib
ifneq (,$(RaylibGame_config))
	@echo "==== Building RaylibGame ($(RaylibGame_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f RaylibGame.make config=$(RaylibGame_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f RaylibGame.make clean
