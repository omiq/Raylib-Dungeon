...
PROJECTS := Raylib-Dungeon raylib

.PHONY: all clean help $(PROJECTS) 

all: $(PROJECTS)

Raylib-Dungeon: raylib
ifneq (,$(Raylib_Dungeon_config))
	@echo "==== Building Raylib-Dungeon ($(Raylib_Dungeon_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f Raylib-Dungeon.make config=$(Raylib_Dungeon_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f Raylib-Dungeon.make clean
